        ...
        <div class="lg:w-1/3 space-y-4 h-[calc(100vh-10vh)]">
          <div class="rounded-xl backdrop-blur-md bg-white/10 p-4 border border-white/20 shadow-lg">
            <div class="h-48 bg-white/10 rounded-lg">
              <v-img :src="data?.banner || '/placeholder.svg?height=200&width=300'" class="rounded-md" fit />
            </div>
          </div>
        ...
        <div class="flex-1">
          <div class="space-y-4 pl-2 pr-2 h-[calc(100vh-10vh)] overflow-y-scroll">
            <div v-for="(card, index) in data?.cards" :key="card.picture"
              ...
              <button class="w-full flex flex-col sm:flex-row sm:items-center gap-4 justify-center items-center "
                ...
                <div
                  ...
                  <img :src="card.picture || '/placeholder.svg?height=200&width=300'"
                    class="w-[20vh] h-[20vh] object-cover rounded-md" alt="Question image" />
                </div>
