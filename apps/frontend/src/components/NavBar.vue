  ...
  <nav :class="[
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center glass-button px-4 py-1 text-3xl
           text-white font-semibold rounded-lg transition-all duration-300 ease-in-out w-fit">Quizzy/{{ handlePath() }}
        </div>
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            <a @click="router.push('/')"
              class="glass-button px-4 py-1 text-lg text-white font-semibold rounded-lg transition-all duration-300 ease-in-out cursor-pointer w-fit">Kezdőlap</a>
            <a href="#"
            ...
            <a @click="router.push('/profil')"
              class="glass-button px-4 py-1 text-lg text-white font-semibold rounded-lg transition-all duration-300 ease-in-out cursor-pointer w-fit">Profil</a>
          </div>
        </div>
        <div class="md:hidden">
