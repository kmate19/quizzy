...
<template>
  <Transition appear enter-active-class="transition ease-in-out duration-1000"
    ...
    border-2 border-white transition-all h-fit cursor-pointer" @click="nextPage(quiz.id)">
      <v-img :src="quiz.banner || '/placeholder.svg?height=200&width=300'" max-width="100%"
