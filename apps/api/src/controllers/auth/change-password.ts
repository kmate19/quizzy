...
const changePasswordHandler = GLOBALS.CONTROLLER_FACTORY(checkJwt(), zv('json', LoginUserSchema.omit({ username_or_email: true }).extend({ oldPassword: z.string() })), async (c) => {
